"""Recognize and emit the cube-face color and encoded-distance presentation pass."""
...
def apply_cube_map_face_present_recipe(
    staging: Path,
    ...
    shaders = [
        ...
        if record["source_name"] == "cube_map_face_present"
    ]
    ...
    return emit_validated_module(
        ...
        blobs,
        compiler,
        recipe_name="cube_map_face_present",
        bodies={shader["selector"]: asset("cube_map_face_present_pixel.hlsl")},
