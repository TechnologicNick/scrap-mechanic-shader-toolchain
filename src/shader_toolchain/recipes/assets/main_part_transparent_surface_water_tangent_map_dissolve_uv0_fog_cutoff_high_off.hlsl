...
// Policy: quality=high, reflection=off
#ifndef cmp
#define cmp -
#endif
  ...
  float3 smin_view_position0, float3 smin_screen_uv0, float4 smin_fog_color0, inout float4 smout_sv_target0, inout float4 smLocalFloat40, inout float4 smLocalFloat41, inout float4 smLocalFloat42, inout float4 smLocalFloat43, inout float4 smLocalFloat44, inout float4 smLocalFloat45, inout float4 smLocalFloat46, inout float4 smLocalFloat47, inout float4 smLocalFloat48, inout float4 smLocalFloat49, inout float4 smLocalFloat410, inout float4 smLocalFloat411, inout float4 smLocalFloat412, inout float4 smLocalFloat413, inout float4 smLocalFloat414, inout float4 smLocalFloat415, inout float4 smLocalFloat416, inout float4 smLocalFloat417)
{
  ...
  smLocalFloat45.xyz = tIndirect.SampleLevel (PointClampClamp_s, smin_screen_uv0.xy, 0).xyz;
  smLocalFloat41.z = dot (smLocalFloat45.xyz, float3 (0.298999995, 0.587000012, 0.114));
  smLocalFloat45.xyz = float3 (1.13, 1.13, 1.13) * smLocalFloat45.xyz;
  smLocalFloat41.z = smLocalFloat41.z * 0.200000003 + 1.39999998;
  smLocalFloat45.xyz = smLocalFloat45.xyz * smLocalFloat41.zzz;
  smLocalFloat41.z = dot (smLocalFloat45.xyz, float3 (0.333333343, 0.333333343, 0.333333343));
  ...
  smLocalFloat46.xyz = smLocalFloat45.xyz * smLocalFloat40.www;
  ...
  smLocalFloat47.xyz = smLocalFloat41.zzz * smLocalFloat46.xyz + - smLocalFloat42.xyz;
  smLocalFloat42.xyz = smLocalFloat40.yyy * smLocalFloat47.xyz + smLocalFloat42.xyz;
  smLocalFloat42.xyz = smLocalFloat44.xyz * smLocalFloat40.zzz + smLocalFloat42.xyz;
  ...
  smLocalFloat40.y = dot (smLocalFloat46.xyz, float3 (0.333333343, 0.333333343, 0.333333343));
  ...
  smLocalFloat40.yzw = smLocalFloat45.xyz * smLocalFloat40.www + - smLocalFloat42.xyz;
