...
// Policy: quality=high, reflection=single
#ifndef cmp
#define cmp -
#endif
  ...
  inout float4 smLocalFloat40, inout float4 smLocalFloat41, inout float4 smLocalFloat42, inout float4 smLocalFloat43, inout float4 smLocalFloat44, inout float4 smLocalFloat45)
{
  ...
  smLocalFloat44.xyz = smLocalFloat44.xyz * smLocalFloat40.yyy;
}
  ...
  float3 smin_view_position0, float3 smin_screen_uv0, float4 smin_fog_color0, inout float4 smout_sv_target0, inout float4 smLocalFloat40, inout float4 smLocalFloat41, inout float4 smLocalFloat42, inout float4 smLocalFloat43, inout float4 smLocalFloat44, inout float4 smLocalFloat45, inout float4 smLocalFloat46, inout float4 smLocalFloat47, inout float4 smLocalFloat48, inout float4 smLocalFloat49, inout float4 smLocalFloat410, inout float4 smLocalFloat411, inout float4 smLocalFloat412, inout float4 smLocalFloat413, inout float4 smLocalFloat414, inout float4 smLocalFloat415, inout float4 smLocalFloat416, inout float4 smLocalFloat417)
{
  ...
  smLocalFloat40.w = dot (smin_view_position0.xyz, smin_view_position0.xyz);
  smLocalFloat40.w = sqrt (smLocalFloat40.w);
  smLocalFloat46.xyz = tIndirect.SampleLevel (PointClampClamp_s, smin_screen_uv0.xy, 0).xyz;
  smLocalFloat41.z = dot (smLocalFloat46.xyz, float3 (0.298999995, 0.587000012, 0.114));
  smLocalFloat46.xyz = float3 (1.13, 1.13, 1.13) * smLocalFloat46.xyz;
  smLocalFloat41.z = smLocalFloat41.z * 0.200000003 + 1.39999998;
  smLocalFloat46.xyz = smLocalFloat46.xyz * smLocalFloat41.zzz;
  smLocalFloat41.z = dot (smLocalFloat46.xyz, float3 (0.333333343, 0.333333343, 0.333333343));
  smLocalFloat43.zw = float2 (1.5, - 6) + smLocalFloat40.ww;
  smLocalFloat43.zw = float2 (0.00999999978, 0.166666672) * smLocalFloat43.wz;
  smLocalFloat40.w = min (1, smLocalFloat43.w);
  smLocalFloat43.z = saturate (smLocalFloat43.z);
  smLocalFloat40.w = smLocalFloat40.w * 1.25 + smLocalFloat43.z;
  smLocalFloat47.xyz = smLocalFloat46.xyz * smLocalFloat40.www;
  smLocalFloat41.z = smLocalFloat41.z * smLocalFloat41.z;
  smLocalFloat41.z = 4 * smLocalFloat41.z;
  smLocalFloat48.xyz = smLocalFloat46.xyz * smLocalFloat40.www + - smLocalFloat44.xyz;
  smLocalFloat44.xyz = smLocalFloat41.zzz * smLocalFloat48.xyz + smLocalFloat44.xyz;
  smLocalFloat48.xyz = smLocalFloat45.xyz * smLocalFloat42.xyz;
  smLocalFloat42.xyz = - smLocalFloat42.xyz * smLocalFloat45.xyz + smLocalFloat44.xyz;
  smLocalFloat42.xyz = smLocalFloat40.yyy * smLocalFloat42.xyz + smLocalFloat48.xyz;
  smLocalFloat42.xyz = smLocalFloat45.xyz * smLocalFloat40.zzz + smLocalFloat42.xyz;
  smLocalFloat40.y = cmp (0.00100000005 < smLocalFloat40.x);
  if (smLocalFloat40.y != 0) {
    smLocalFloat40.y = - smLocalFloat41.w * smLocalFloat41.w + 1;
    smLocalFloat40.y = - smLocalFloat40.y * 0.565323055 + 1;
    smLocalFloat40.y = sqrt (smLocalFloat40.y);
    smLocalFloat40.y = smLocalFloat41.w * - 0.751879692 + - smLocalFloat40.y;
    smLocalFloat40.yz = smLocalFloat40.yy * smLocalFloat41.xy;
    smLocalFloat40.yz = smLocalFloat43.xy * float2 (0.751879692, 0.751879692) + smLocalFloat40.yz;
    smLocalFloat41.x = 0.100000001 * cb_fProjectionScale;
    smLocalFloat41.y = max (9.99999997e-07, - smin_view_position0.z);
    smLocalFloat41.x = smLocalFloat41.x / smLocalFloat41.y;
    smLocalFloat40.yz = smLocalFloat41.xx * smLocalFloat40.yz;
    smLocalFloat40.yz = cb_vContainerPixelSize.xy * smLocalFloat40.yz;
    smLocalFloat40.yz = smLocalFloat40.yz * cb_vRenderScale.xy + smin_screen_uv0.xy;
    smLocalFloat41.xyz = tFrame.Sample (LinearClampClamp_s, smLocalFloat40.yz).xyz;
    smLocalFloat43.xyz = smLocalFloat42.xyz + - smLocalFloat41.xyz;
    smLocalFloat42.xyz = smLocalFloat40.xxx * smLocalFloat43.xyz + smLocalFloat41.xyz;
  }
  smLocalFloat40.y = dot (smLocalFloat47.xyz, float3 (0.333333343, 0.333333343, 0.333333343));
  smLocalFloat40.y = 3 * smLocalFloat40.y;
  smLocalFloat40.x = max (0.125, smLocalFloat40.x);
  smLocalFloat40.x = smLocalFloat40.y * smLocalFloat40.x;
  smLocalFloat40.yzw = smLocalFloat46.xyz * smLocalFloat40.www + - smLocalFloat42.xyz;
  smLocalFloat40.xyz = smLocalFloat40.xxx * smLocalFloat40.yzw + smLocalFloat42.xyz;
  smLocalFloat41.xyz = smin_fog_color0.xyz + - smLocalFloat40.xyz;
  smout_sv_target0.xyz = smin_fog_color0.www * smLocalFloat41.xyz + smLocalFloat40.xyz;
}
