// Shared rigid explicit-LTW vertex reconstruction.

struct MainPartRigidSurfaceVertex
{
  float4 clipPosition;
  float3 viewPosition;
  float2 uv0;
...
MainPartRigidSurfaceVertex EvaluateMainPartRigidSurfaceVertex(
...
{
  MainPartRigidSurfaceVertex result;
