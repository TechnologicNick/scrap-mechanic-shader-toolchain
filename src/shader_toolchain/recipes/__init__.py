...
from .cmp_hzb_hdr import apply_cmp_hzb_hdr_recipe
...
from .gen_reflection_probe import apply_gen_reflection_probe_recipe
...
RECIPES = (
    ...
    apply_gen_reflection_probe_recipe,
)
